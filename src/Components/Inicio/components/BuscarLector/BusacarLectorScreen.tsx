...
import {Button, ButtonGroup, FormControl, Grid, InputLabel, Select, TextField, InputAdornment} from "@mui/material";
...
import { ModalEditarLector } from "./ModalEditarLector/ModalEditarLector";
...
export const BusacarLectorScreen: React.FC = () => {
            ...
            renderCell: (params: any) => (
                <div>
                    ...
                    <Button
                        ...
                        onClick={() => deleteUsuario(params.row.id)}>
                        <DeleteIcon />
                    </Button>
                </div>
            ),
    ...
    const deleteUsuario = async (id: number) => {
        try {
            const result = await Swal.fire({
                title: '¿Está seguro?',
                text: 'Esta acción eliminará al usuario de la base de datos de forma permanente.',
                icon: 'warning',
                showCancelButton: true,
                confirmButtonColor: '#006b0a', // Color verde
            ...
            console.error(error);
            Swal.fire('Error', 'Ha ocurrido un error al intentar eliminar al usuario.', 'error');
        }
    };
